            ...
            >
              <div className="flex justify-between items-center pb-3 mb-3 border-b border-gray-100 shrink-0">
                <h3 className="text-base sm:text-lg font-bold text-[#1F6F5F] flex items-center gap-2">
                  <Plus className="w-4 h-4 sm:w-5 sm:h-5 text-[#2FA084]" /> Add B2B Partner
                </h3>
              ...
              <form onSubmit={handleAddParty} className="space-y-3 sm:space-y-4 flex-1 flex flex-col justify-between">
                <div>
                  <label className="block text-[10px] sm:text-xs font-bold text-[#111111]/70 uppercase tracking-wider mb-1">Partner / Business Name</label>
                  <input
                    required
        ...
        {isAddEntryOpen && (
          <div className="fixed inset-0 z-50 flex flex-col sm:items-center sm:justify-center sm:p-4 overflow-hidden" style={{ background: 'rgba(10,30,25,0.65)', backdropFilter: 'blur(8px)', WebkitBackdropFilter: 'blur(8px)' }}>
            ...
            >
              <div className="flex justify-between items-center pb-3 mb-3 border-b border-gray-100 shrink-0">
                <h3 className="text-base sm:text-lg font-bold text-[#1F6F5F] flex items-center gap-2">
                  <Plus className="w-4 h-4 sm:w-5 sm:h-5 text-[#2FA084]" /> Record B2B Ledger Entry
                </h3>
              ...
              <form onSubmit={handleAddEntry} className="space-y-3 sm:space-y-4 flex-1 overflow-y-auto pr-0.5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                  <div className="relative">
                    <label className="block text-[11px] font-bold text-[#111111]/70 uppercase tracking-wider mb-1">Select Partner (Type or Select)</label>
                    <div className="relative">
                      <input
                        required
                ...
                <div className="grid grid-cols-2 gap-2.5 sm:gap-4">
                  <div>
                    ...
                    />
                    <p className="text-[9px] text-gray-400 mt-0.5 truncate">Sale Bill // Maal Vaicho</p>
                  </div>
                  <div>
                    <div className="flex flex-col mb-1">
                    ...
                    />
                    <p className="text-[9px] text-gray-400 mt-0.5 truncate">Purchase // Payment Recv</p>
                  </div>
                </div>
